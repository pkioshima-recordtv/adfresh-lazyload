...
googletag.cmd.push(function() {
  googletag.pubads().enableLazyLoad({
    fetchMarginPercent: 200, // <---- Editar esse valor para alterar a distância em viewports em que o ad request ocorre.
    renderMarginPercent: 50, // <---- Editar esse valor para alterar a distância em viewports em que o ad é renderizado.
  ...
  googletag.pubads().addEventListener('impressionViewable', function(event) {
    ...
    var div = document.getElementById(divId).lastChild
    console.log(div)
